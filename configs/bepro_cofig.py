...
data = dict(
    ...
    train=dict(
        type=dataset_type,
       ann_file='/home/dmitriy.khvan/mmdetection/data/stitched_images_annotation/ann_file_temp.txt',
...
# load_from = '/home/dmitriy.khvan/mmdetection/work_dirs/cascade_rcnn_r50_fpn_1x/epoch_5.pth'
